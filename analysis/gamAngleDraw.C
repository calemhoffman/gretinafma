...
Int_t fitType[10]={1,1,1,1,1,1,1,1};
Int_t rebinFactor[10]={4,4,4,4,4,4,4,4};
Float_t maxGraphY[10]={200,200,200,200,200,200,200,200};
...
for (Int_t whichGam=0;whichGam<numGam;whichGam++) {
  ...
  if (numAngles>=10) {cc[whichGam]->Clear(); cc[whichGam]->Divide(5,5);}
