...
//histograms
  ...
  TH2F *he1e3c = new TH2F("he1e3c","; E_{3} [arb. units]; E_{1} [arb. units]",400,0,5000,400,0,5000);
  ct->Draw("e[0]:e[2]>>he1e3c","Entry$<1e9&&e[1]>200&&dtime>70&&dtime<85","col");
  he1e3c->SetStats(0);he1e3c->GetZaxis()->SetRangeUser(1,1e2);
  TH2F *he1e3p0 = new TH2F("he1e3p0","; E_{3} [arb. units]; E_{1} [arb. units]",400,0,5000,400,0,5000);
  pt->Draw("py_e[0]:py_e[2]>>he1e3p0",Form("Entry$<1e5&&py_mlreturn>%f&&py_mlreturn<=%f",mlcut[0],mlcut[1]),"same");
  he1e3p0->SetStats(0); he1e3p0->SetMarkerStyle(20);
  he1e3p0->SetMarkerColorAlpha(ci_gre, trans);
  TH2F *he1e3p1 = new TH2F("he1e3p1","; E_{3} [arb. units]; E_{1} [arb. units]",400,0,5000,400,0,5000);
  pt->Draw("py_e[0]:py_e[2]>>he1e3p1",Form("Entry$<1e5&&py_mlreturn>%f&&py_mlreturn<=%f",mlcut[1],mlcut[4]),"same");
  he1e3p1->SetStats(0); he1e3p1->SetMarkerStyle(20);
  he1e3p1->SetMarkerColorAlpha(ci_yel, trans);
  TH2F *he1e3p2 = new TH2F("he1e3p2","; E_{3} [arb. units]; E_{1} [arb. units]",400,0,5000,400,0,5000);
  pt->Draw("py_e[0]:py_e[2]>>he1e3p2",Form("Entry$<1e5&&py_mlreturn>%f&&py_mlreturn<=%f",mlcut[2],mlcut[4]),"same");
  he1e3p2->SetStats(0); he1e3p2->SetMarkerStyle(20);
  he1e3p2->SetMarkerColorAlpha(ci_blu, trans);
  TH2F *he1e3p3 = new TH2F("he1e3p3","; E_{3} [arb. units]; E_{1} [arb. units]",400,0,5000,400,0,5000);
  pt->Draw("py_e[0]:py_e[2]>>he1e3p3",Form("Entry$<1e5&&py_mlreturn>%f&&py_mlreturn<=%f",mlcut[3],mlcut[4]),"same");
  he1e3p3->SetStats(0); he1e3p3->SetMarkerStyle(20);
  he1e3p3->SetMarkerColorAlpha(ci_pur, trans); // he1e3p60->SetMarkerColor(kBlue);

  TH2F *he1e2c = new TH2F("he1e2c","; E_{2} [arb. units]; E_{1} [arb. units]",400,0,5000,400,0,5000);
  ct->Draw("e[0]:e[1]>>he1e2c","Entry$<1e9&&e[1]>200&&dtime>70&&dtime<85","col");
  he1e2c->SetStats(0);he1e2c->GetZaxis()->SetRangeUser(1,1e2);
  TH2F *he1e2p0 = new TH2F("he1e2p0","; E_{2} [arb. units]; E_{1} [arb. units]",400,0,5000,400,0,5000);
  pt->Draw("py_e[0]:py_e[1]>>he1e2p0",Form("Entry$<1e5&&py_mlreturn>%f&&py_mlreturn<=%f",mlcut[0],mlcut[1]),"same");
  he1e2p0->SetStats(0); he1e2p0->SetMarkerStyle(20);
  he1e2p0->SetMarkerColorAlpha(ci_gre, trans);
  TH2F *he1e2p1 = new TH2F("he1e2p1","; E_{2} [arb. units]; E_{1} [arb. units]",400,0,5000,400,0,5000);
  ...
  TH2F *he1e2p2 = new TH2F("he1e2p2","; E_{2} [arb. units]; E_{1} [arb. units]",400,0,5000,400,0,5000);
  ...
  TH2F *he1e2p3 = new TH2F("he1e2p3","; E_{2} [arb. units]; E_{1} [arb. units]",400,0,5000,400,0,5000);
...
cc->cd(1);gPad->SetLogz();
//he1e3c->Rebin2D();
he1e3c->SetMinimum(1); he1e3c->SetMaximum(5e3);
he1e3c->GetXaxis()->SetRangeUser(0,4000);
he1e3c->GetYaxis()->SetRangeUser(600,3000);
he1e3c->GetXaxis()->SetLabelSize(0);
he1e3c->GetXaxis()->SetTickLength(0);
he1e3c->GetYaxis()->SetLabelSize(0);
he1e3c->GetYaxis()->SetTickLength(0);
// he1e3c->SetXTitle("E_{2} [arb. units]")
// he1e3c->SetYTitle("E_{1} [arb. units]")
he1e3c->GetXaxis()->CenterTitle();
he1e3c->GetYaxis()->CenterTitle();
he1e3c->Draw("col");
...
// he1e2c->Rebin2D();
he1e2c->SetMinimum(1); he1e2c->SetMaximum(5e3);
he1e2c->GetXaxis()->SetRangeUser(200,2400);
he1e2c->GetYaxis()->SetRangeUser(600,3000);
he1e2c->GetXaxis()->SetLabelSize(0);
he1e2c->GetXaxis()->SetTickLength(0);
he1e2c->GetYaxis()->SetLabelSize(0);
he1e2c->GetYaxis()->SetTickLength(0);
// he1e3c->SetXTitle("E_{2} [arb. units]")
// he1e3c->SetYTitle("E_{1} [arb. units]")
he1e2c->GetXaxis()->CenterTitle();
he1e2c->GetYaxis()->CenterTitle();
he1e2c->Draw("col");
