...
data_in = rnp.root2array("../data/pyTreeAverageFatG_train.root","pytree",
...
torch.save(net, "./model_saves/model_G.pt")
...
#dump to csv
result_df.to_csv("output/pyTreeAverageFatG_train.csv",sep=" ",header=False)
