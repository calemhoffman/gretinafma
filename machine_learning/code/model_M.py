...
#model M 5k batch, 2 epochs, new model below
class Net(nn.Module):
...
torch.save(net, "./model_saves/model_M.pt")
...
#dump to csv
result_df.to_csv("output/pyTreeAverageSkinM_train.csv",sep=" ",header=False)
