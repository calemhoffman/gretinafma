...
data_in = rnp.root2array("../data/pyTreeAverageFatD_train.root","pytree",
...
torch.save(net, "./model_saves/model_E.pt")
...
#dump to csv
result_df.to_csv("output/pyTreeAverageFatE_train.csv",sep=" ",header=False)
