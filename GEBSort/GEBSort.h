...
typedef struct PARS
{
  ...
  float linpol_rrlo;
  float linpol_rrhi;
  float linpol_polrangelo;
  float linpol_polrangehi;
  float linpol_comptonrangelo;
  float linpol_comptonrangehi;
  float linpol_FOMlo;
  float linpol_FOMhi;
  float linpol_source_e;
  float linpol_source_de;
  int   linpol_mode;
  float GGLOp, GGHIp, GGLOb,GGHIb, GGWp, GGWb;
  float dgs_MM;
  char  dgs_PZfn[256];
  char  dgs_ecalfn[256];
